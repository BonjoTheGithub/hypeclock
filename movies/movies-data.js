window.HYPE_MOVIES={
  ...
  "upcoming": [
    ...
    },
    {
      ...
      "critic_score": null,
      "us_rating": null,
      "plot": "On a stormy night in Rome, Anna arrives at her daughter Alice’s apartment with a devastating confession: their entire family history is built on a lie. Twenty years earlier, after a horrific accident that nearly cost Alice her leg, Anna claims she made a pact with a mysterious Stranger to save her. But the miracle came at a price. What she believed was a single desperate bargain has in fact unleashed a spiraling chain reaction — a domino effect of increasingly dark events that have haunted their lives ever since. Now, the Stranger has come to collect. And Anna is convinced that only Alice can break the spiral and set things right. But at what cost?",
    ...
    },
    {
      ...
      "critic_score": null,
      "us_rating": null,
      "plot": "Over one transformative summer in rural New Zealand in 2006, a 14-year-old explores desire and identity as she turns to the internet. Trying to imitate the people she longs to be loved by, she slowly discovers what feels real to her.",
  ...
  "kids": [
    {
      ...
      "critic_score": 91,
      "us_rating": null,
      "plot": "After a shipwreck, an intelligent robot is stranded on an uninhabited island. As the robot learns to survive among wary animals, it forms an unexpected bond with an orphaned gosling and takes on the challenge of raising it in the wild.",
    ...
    },
    {
      ...
      "critic_score": 83,
      "us_rating": "PG",
      "plot": "After solving a major case, two police partners follow a twisting mystery when a snake’s arrival disrupts the animal metropolis. Their investigation takes them undercover into unfamiliar parts of town, testing their teamwork while raising questions about prejudice, stereotypes, greed, and the city’s past.",
